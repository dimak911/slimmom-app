...
export const FoneImages = styled.div`
  ...
  @media screen and (min-width: 768px) {
    ...
    background-position: right 0px top 461px, right 0px bottom 0px, right 12px top 0px,
  ...
  @media (min-device-pixel-ratio: 2) and (min-width: 768px),
    ...
    background-image: url(${tabletStrawberry2x}), url(${tabletBanana2x}), url(${tabletLeafs2x}),
      url(${tabletFone2x});
  }
